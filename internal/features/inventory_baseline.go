...
func baselineFeatures() []Feature {
	...
	return []Feature{
		...
		row("foundation.runtime-stabilization", "runtime stabilization gate", "foundation", shipped, shipped, parity, "0057"),
		...
		row("runtime.tsconfig-paths", "tsconfig and path aliases", "runtime", shipped, shipped, parity, "0053"),
